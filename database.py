...
class Database:
    ...
    def init_db(self):
        ...
        # Tabel untuk menyimpan username yang diverifikasi
        cursor.execute('''
        CREATE TABLE IF NOT EXISTS verified_usernames (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            username TEXT UNIQUE,
            target_type TEXT,  -- 'user', 'channel', 'group', 'supergroup'
            target_id INTEGER,
            title TEXT,
            owner_id INTEGER,
            owner_username TEXT,
            added_by INTEGER,  -- telegram_id of user who added it
